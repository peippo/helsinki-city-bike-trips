...
export const SearchLocationIcon: React.FC<IconProps> = ({ width, ...rest }) => (
  <IconBase
    width={width}
    viewBoxWidth={512}
    viewBoxHeight={512}
...
export const CircleTimesIcon: React.FC<IconProps> = ({ width, ...rest }) => (
  <IconBase
    width={width}
    viewBoxWidth={512}
    viewBoxHeight={512}
...
export const PinSlashIcon: React.FC<IconProps> = ({ width, ...rest }) => (
  <IconBase
    width={width}
    viewBoxWidth={640}
    viewBoxHeight={512}
